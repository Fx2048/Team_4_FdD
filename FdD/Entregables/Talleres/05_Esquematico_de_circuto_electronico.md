...
Asimismo, procedemos a enlazar cada uno de los elementos donde respectivamente les corresponde.
  ...
  . La patilla P2 del conector J1(Bateria) está conectada a la patilla P1 de la resistencia R1.
...
## Parte 2: Caja central 

Para el circuito de la caja central solamente se utilizará la bateria, el ESP32 y el NRF24L01, esto nos permitirá recibir y recolectar los datos brindados por el componente 

<p align="center">
    <img src="https://github.com/Fx2048/Team_4_FdD/blob/main/Im%C3%A1genes/05_circuito/7_part2.png" width="420" height="380" style="margin: auto;">
</p>

<p align="justify">
Este circuito representa al dispositivo de recepción de datos, esta lo compone un módulo esp32, para el envío de datos a la nube, el módulo NRF( para la recepción de datos del otro NRF) y una batería de nueve voltios que permite el funcionamiento de este dispositivo. </p>


## <p align= "center" > **Vista general en 2D:** </p>

<p align="center">
    <img src="https://github.com/Fx2048/Team_4_FdD/blob/main/Im%C3%A1genes/05_circuito/8_dosd.png" width="420" height="380" style="margin: auto;">
</p>
